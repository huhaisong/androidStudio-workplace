...
import com.example.a3d_load.Normal;
...
public class LoadUtil {
    ...
    public static LoadedObjectVertexNormalTexture loadTextureFromFile(String fname, Resources r, MySurfaceView mv) {
