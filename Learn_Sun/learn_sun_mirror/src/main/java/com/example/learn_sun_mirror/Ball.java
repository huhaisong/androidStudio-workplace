...
import static com.example.learn_sun_mirror.Constant.*;
...
public class Ball {
    ...
    int maCameraLocationHandle; //摄像机位置属性引用
    ...
    public void initShader(MySurfaceView mv) {
        ...
        maCameraLocationHandle = GLES20.glGetUniformLocation(mProgram,"uCamera");
    }
    ...
    public void drawSelf() {
        ...
        GLES20.glUniform3fv(maCameraLocationHandle,1,MatrixState.cameraLocationFB);
        //将顶点位置数据传入渲染管线
