...
public class VRListImg {
    ...
    private static final String TAG = "VRListImg";
                        ...
                        if (item.IsVideo) {
                            ...
                            if (videobitmap != null) {
                                ...
                                canvas.drawBitmap(videobitmap,
                                        new Rect(0, 0, videobitmap.getWidth(), videobitmap.getHeight()),
                                        new Rect(tleft, ttop, tleft + videobitmap.getWidth(), ttop + videobitmap.getHeight()), null);
                                videobitmap.recycle();
                            }
                        }
                    }
