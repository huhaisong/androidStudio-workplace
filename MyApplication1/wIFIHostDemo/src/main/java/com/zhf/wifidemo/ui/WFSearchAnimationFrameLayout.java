...
public class WFSearchAnimationFrameLayout extends FrameLayout {
    ...
    private SoftReference<Bitmap> m_bitmapRipple;//���� �������ã�
    ...
    private void loadRadarBitmap() {
        try {
            m_bitmapRipple = new SoftReference<Bitmap>(BitmapFactory.decodeStream(getContext().getResources().openRawResource(R.drawable.wifi_body_ripple)));
