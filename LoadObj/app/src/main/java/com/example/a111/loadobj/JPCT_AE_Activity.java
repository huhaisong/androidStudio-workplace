...
public class JPCT_AE_Activity extends Activity {
    ...
    private static final String TAG = "JPCT_AE_Activity";
...
/*        // 停止
        ...
        public void onSurfaceChanged(GL10 gl, int w, int h) {
            ...
            if (master == null) {
                ...
                Drawable drawable = ContextCompat.getDrawable(JPCT_AE_Activity.this, R.drawable.ic_launcher);
                Texture texture = new Texture(BitmapHelper.rescale(BitmapHelper.convert(drawable), 64, 64));
                ...
                sqhere = Primitives.getSphere(10);
                // 以纹理的方式给对象所有面"包装"上纹理
                cube.calcTextureWrapSpherical();
                sqhere.calcTextureWrapSpherical();
                // 给对象设置纹理
                cube.setTexture("texture");
                sqhere.setTexture("texture");
                ...
                cam.lookAt(sqhere.getTransformedCenter());
                ...
                // 将当前SimpleVector的x,y,z值设为给定的SimpleVector(ube.getTransformedCenter())的值
                sv.set(cube.getTransformedCenter());
                sv.set(sqhere.getTransformedCenter());
                // Y方向上减去100
                sv.y -= 100;
                // Z方向上减去100
                sv.z -= 100;
