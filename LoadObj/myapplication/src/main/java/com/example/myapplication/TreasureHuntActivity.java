...
public class TreasureHuntActivity
    ...
    private static String mVertexShader = "uniform mat4 u_MVP;" +
    ...
    public void onSurfaceCreated(EGLConfig config) {
        ...
        int vertexShader = loadGLShader(GLES20.GL_VERTEX_SHADER, mVertexShader);
        int gridShader = loadGLShader(GLES20.GL_FRAGMENT_SHADER, mFragmentShader);
        ...
        Matrix.translateM(modelFloor, 0, 0, -20.0f, 0); // Floor appears below user.
